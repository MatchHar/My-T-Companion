...
The 1.10.44 release is compatible with TeslaMate 4.2.0 and the previous 4.1.1
...
Version 1.10.44 changes only destination-navigation leg classification and
stored monitor state. It requires no database, API, pairing, proxy, Tesla
token, notification-preference, or stored-history migration and remains
compatible with existing My T clients.
